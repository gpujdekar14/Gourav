<div class="content-wrapper" style="min-height: 1000.8px;">
    ...
    <!-- Main content -->
<section class="content" style="min-height: 1000.8px;" ng-app="myApp" ng-controller="purchaseReportCtrl" ng-init="init()">
                ...
                <div class="panel panel-default ">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="col-md-12 input-group">
                                <select class="form-control select2" name="supplier" id="customer">
                                    <option value="">All</option>
