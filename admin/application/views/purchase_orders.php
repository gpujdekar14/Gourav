<div class="content-wrapper" style="min-height: 1000.8px;">
    ...
    <div class="box" ng-show="showUploadFile">
        ...
        <div class="box" ng-show="showAddUpdate">
            <div class="box-header with-border">
                <h3 class="box-title" ng-show="!order_id">New Purchase Orders</h3>
                <h3 class="box-title" ng-show="order_id">Update Purchase Orders</h3>
         ...
         <button type="button" class="btn btn-success btn-flat" ng-click="showAddItem()">Add Custom Item</button>
           ...
           <td> <input type="text" class="form-control" ng-show="addItem" id="inputPassword" placeholder="" ></td>
             ...
             <tr class="tableInfo"><td colspan="5" align="right"><strong>Sub Total</strong></td><td align="left" colspan="1"><input type="text" class="form-control" ng-show="addItem" id="inputPassword" placeholder="" ></td></tr>
                  <tr class="tableInfo"><td colspan="5" align="right"><strong>Total Tax</strong></td><td align="left" colspan="1"><input type="text" class="form-control" ng-show="addItem" id="inputPassword" placeholder="" ></td></tr>
                  <tr class="tableInfo"><td colspan="5" align="right"><strong>Grand Total</strong></td><td align="left" colspan="1"><input type='text' name="total" class="form-control" id = "grandTotal" readonly></td></tr>
        ...
        <div class="box-footer">
            ...
            <div class="col-md-2">
                ...
                <a href="<?php echo site_url('GeneratePurchaseOrder');?>"><input type="button" class="btn btn-flat btn-success" ng-show="!order_id"  value="Submit" ng-click="add()">
                </a>
          </div>
    </div>
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="col-md-12">
                  ...
                  <div class="col-md-2">
                    <button type="button" class="btn btn-success btn-flat" ng-show="showAddButton" ng-click="showAdd()"><i class="fa fa-plus"></i> Add New Purchase Order</button>
                </div>
                <div class="col-md-4">
                <button type="button" class="btn btn-primary btn-flat" ng-show="showImportButton" ng-click="uploadFile()"><i class="fa fa-plus"></i> Import New Item</button>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-2">
                <button type="button" class="btn btn-info btn-flat" ng-show="showFilters" ng-click="showFilters()"> Filter</button>
                 </div>
            </div>
        </div>
...
<!-- app.js -->
<script src="<?php echo base_url('assets/angular/angularjs/controller/purchase-orders.js'); ?>"></script>
<style>
    .tooltip {
        position: relative;
