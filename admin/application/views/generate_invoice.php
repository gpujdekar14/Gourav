        ...
        <div class="box" ng-show="showAddUpdate">
          ...
          <div class="box-body">      
            <div class="col-md-12" ng-show="addUpdateUsers">
                <div class="panel panel-default ">  <a href="<?php echo site_url('Invoice');?>">  <button type="button" class="btn btn-success btn-flat" ng-click="showAdd()"><i class="fa fa-plus"></i> Add New Invoice</button>
