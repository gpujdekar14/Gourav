          ...
          <div class="box-body">      
            <div class="col-md-12" ng-show="addUpdateUsers">
                <div class="panel panel-default ">
                    ...
                    <div class="col-md-12">
                          <div class="col-md-6">
                            <h4 class="text-info text-center">Customer Information</h4>
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="form-group" id="select_div">
                                      <label class="col-sm-4 control-label require" for="inputEmail3">State<span class="text-red">*</span></label>

                                      <div class="col-sm-8">
                                        <select class="form-control select2" name="bill_state" id="bill_state_select">
                                           <option value="">Select One</option>
                                        </select>
                                      </div>
                                </div>
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="col-md-12">
                  ...
                  <div class="col-md-2">
                    <button type="button" class="btn btn-success btn-flat" ng-click="showAdd()"><i class="fa fa-plus"></i> Add New Customer</button>
                </div>
                <div class="col-md-4">
...
<!-- app.js -->
<script src="<?php echo base_url('assets/angular/angularjs/controller/add-customer.js'); ?>"></script>
<style>
    .tooltip {
        position: relative;
